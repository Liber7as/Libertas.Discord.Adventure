...
public static class TestServiceFactory
{
        ...
        CombatSettings? combatSettings = null)
    {
        ...
        var xpDistributor = new XpDistributor(progression);
        var lootDistributor = new LootDistributor(calc);
        var damageApplier = new DamageApplier(progression);
    ...
    /// </summary>
    public static CombatSettings CreateTestCombatSettings()
    {
    ...
    /// </summary>
    public static LocalizationSettings CreateTestLocalizationSettings()
    {
    ...
    /// </summary>
    public static BotSettings CreateTestBotSettings()
    {
    ...
    /// </summary>
    public static ProgressionSettings CreateTestProgressionSettings()
    {
