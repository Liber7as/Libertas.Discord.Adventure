...
/// </remarks>
public class MobFactoryService(IMobPresetService presetService, IRandomNumberGenerator rng, ILogger<MobFactoryService> logger) : IMobFactoryService
{
    private readonly ILogger<MobFactoryService> _logger = logger ?? throw new ArgumentNullException(nameof(logger));
    private readonly IMobPresetService _presetService = presetService ?? throw new ArgumentNullException(nameof(presetService));
